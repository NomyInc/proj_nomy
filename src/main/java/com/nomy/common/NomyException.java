package com.nomy.common;

/**
 * The NomyException class is a generic RuntimeException for non-recoverable
 * errors thrown in the application that do not have a specific exception.
 */
public class NomyException extends RuntimeException {
	 ...
	 *            unknown.)
	 */
	public NomyException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public NomyException(String message) {
		super(message);
	}
	 ...
	 *            unknown.)
	 */
	public NomyException(Throwable cause) {
		super(cause);
	}
